...
// Eu crio tres listas, cada uma com seu grupo de palavras aleatorias
  string[] firstWords = ["SeuMadruga", "Chiquinha", "Quico", "Chaves", "DonaFlorinda", "ProfessorGirafales", "Nhonho", "Popis", "Godinez", "Jaiminho", "Girafales", "BruxaDo71", "Sapateiro", "SenhorBarriga", "SeuFurtado" ];
  string[] secondWords = ["Bamboleou", "Xepocou", "Borocoxizou", "Gorfadou", "Engrupou", "Saracoteou", "Esbaldou", "Zarpou", "Abestalhou", "ChorouDeBarrigaCheia", "Desmunhecou", "Zombetou", "Pamonhou", "Baguncou", "Bocarreou"];
  string[] thirdWords = ["Pastelzao", "Coxinhanito", "Cachorroquenteao", "Hamburguerdoidao", "Lasanhabomba", "Pizzaexplosiva", "Arrozdoceengasgado", "Macarronadapedreira",  "Pudimdeconcreto",  "TortaDeClimao",  "Feijoadarretada",  "PaoDeQueijobrek", "EscondidinhoDeIlusao", "BoloDeEnganar",  "SushiDeChule"];
  ...
  constructor() ERC721 ("TurmaDoChavesNFT", "ELCHAVO") {
    console.log("Meu contrato da TurmaDoChaves NFT! Tchu-hu");
  }
